...
DHT dht(D2, DHT22);                                             //DHT config

uint64_t mili_dht;                                              //timeout DHT variable
float    h, t;                                                  //humidity & temperature variables

uint32_t  pin_vent  = D8;                                       //fan pin
uint32_t  pin_heat  = D4;                                       //heater pin
uint32_t  pin_light = D9;                                       //led strip pin (mosfet)
uint32_t  pin_mist  = D7;                                       //humidifier pin
